...
import tn.Pi.Repository.PopulationCibleRepository;
import tn.Pi.Repository.UserRepository;
import tn.Pi.Service.AdService;
import tn.Pi.entities.Ad;
import tn.Pi.entities.PopulationCible;
...
public class AdController {
	...
	public String Chatbot(@RequestParam("reponse") String reponse) throws ParseException
	{
		...
		if(question.equals("what canal do u want to go through?\nfacebook\ntwitter\ngoogleAds"))
		{
			...
			{
				ad.setCanal(tn.Pi.entities.canal.facebook);
			}
			else if(reponse.equals("twitter"))
			{
				ad.setCanal(tn.Pi.entities.canal.twitter);
			}
			else if(reponse.equals("googleAds"))
			{
				ad.setCanal(tn.Pi.entities.canal.googleAds);
			}
