...
public class Rendez_vousController {
	...
	@PostMapping("/saveRendez_vous")
	@ResponseBody
	public void saveRendez_vous(@RequestBody Rendez_vous rendez_vous)
	{
		//conversion de la date /
        //SimpleDateFormat dateformat = new SimpleDateFormat("yyyy-MM-dd");
        //Date date = dateformat.parse(String.valueOf(date));
        //rendez_vous.setDate(dateRendez_vous);
      
		rendez_vousService.saveRendez_vous(rendez_vous);
